// src/lib.rs
/*
 * Core library for VuepressTheme
 */
...
#[derive(Debug)]
pub struct VuepressThemeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl VuepressThemeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting VuepressTheme processing");
    
    let mut processor = VuepressThemeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = VuepressThemeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = VuepressThemeProcessor::new(false);
